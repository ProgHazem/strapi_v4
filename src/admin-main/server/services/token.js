...
const getTokenOptions = () => {
  const { options, secret } = strapi.config.get('admin-main.auth', {});
 ...
 * @param {object} user - admin-main user
 */
...
const checkSecretIsDefined = () => {
  if (strapi.config.serveAdminPanel && !strapi.config.get('admin-main.auth.secret')) {
    throw new Error(
