...
const NpmPackageCard = ({
  ...
  const madeByStrapiMessage = formatMessage({
    id: 'admin-main.pages.MarketPlacePage.plugin.tooltip.madeByStrapi',
              ...
              {attributes.validated && !attributes.madeByStrapi && (
                <Tooltip
                  description={formatMessage({
                    id: 'admin-main.pages.MarketPlacePage.plugin.tooltip.verified',
      ...
      <Stack horizontal spacing={2} style={{ alignSelf: 'flex-end' }} paddingTop={6}>
        <LinkButton
          ...
          aria-label={formatMessage(
            {
              id: 'admin-main.pages.MarketPlacePage.plugin.info.label',
        ...
        >
          {formatMessage({
            id: 'admin-main.pages.MarketPlacePage.plugin.info.text',
