    ...
    return (
      <Box paddingLeft={4}>
        ...
        <Typography variant="omega" textColor="success600" fontWeight="bold">
          {formatMessage({
            id: 'admin-main.pages.MarketPlacePage.plugin.installed',
    ...
    return (
      <CopyToClipboard
        onCopy={() => {
          ...
          toggleNotification({
            type: 'success',
            message: { id: 'admin-main.pages.MarketPlacePage.plugin.copy.success' },
          });
        }}
        text={commandToCopy}
      >
        <Button size="S" startIcon={<Duplicate />} variant="secondary">
          {formatMessage({
            id: 'admin-main.pages.MarketPlacePage.plugin.copy',
