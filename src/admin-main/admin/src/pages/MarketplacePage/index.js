...
const MarketPlacePage = () => {
  ...
  useEffect(() => {
    if (!isInDevelopmentMode) {
      toggleNotification({
        type: 'info',
        message: {
          id: 'admin-main.pages.MarketPlacePage.production',
          ...
          >
            <Box paddingBottom={2}>
              <Typography textColor="neutral700" variant="alpha">
                {formatMessage({
                  id: 'admin-main.pages.MarketPlacePage.offline.title',
            ...
            <Box paddingBottom={6}>
              <Typography textColor="neutral700" variant="epsilon">
                {formatMessage({
                  id: 'admin-main.pages.MarketPlacePage.offline.subtitle',
                  defaultMessage:
  ...
  const emptySearchMessage = formatMessage(
    {
      id: 'admin-main.pages.MarketPlacePage.search.empty',
  ...
  return (
    <Layout>
      <Main>
        <Helmet
          title={formatMessage({
            id: 'admin-main.pages.MarketPlacePage.helmet',
        ...
        <ContentLayout>
          <Box width="25%" paddingBottom={4}>
            <Searchbar
              ...
              clearLabel={formatMessage({
                id: 'admin-main.pages.MarketPlacePage.search.clear',
                defaultMessage: 'Clear the search',
              })}
              placeholder={formatMessage({
                id: 'admin-main.pages.MarketPlacePage.search.placeholder',
          ...
          <TabGroup
            label={formatMessage({
              id: 'admin-main.pages.MarketPlacePage.tab-group.label',
          ...
          >
            <Box paddingBottom={4}>
              <Tabs>
                <Tab>
                  {formatMessage({
                    id: 'admin-main.pages.MarketPlacePage.plugins',
                ...
                <Tab>
                  {formatMessage({
                    id: 'admin-main.pages.MarketPlacePage.providers',
