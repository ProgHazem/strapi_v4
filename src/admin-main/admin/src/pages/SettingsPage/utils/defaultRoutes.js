...
const defaultRoutes = [
  ...
  },
  {
    async Component() {
      const component = await import(
        /* webpackChunkName: "admin-main-edit-roles-page" */ '../pages/Roles/ProtectedEditPage'
      );
  ...
  },
  {
    async Component() {
      const component = await import(
        /* webpackChunkName: "admin-main-users" */ '../pages/Users/ProtectedListPage'
      );
  ...
  },
  {
    async Component() {
      const component = await import(
        /* webpackChunkName: "admin-main-edit-users" */ '../pages/Users/ProtectedEditPage'
      );
