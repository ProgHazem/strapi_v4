...
/**
 * Listen to files change and copy the changed files in the .cache/admin-main folder
...
async function watchAdminFiles(dir) {
  ...
  // Only watch the admin-main/app.js file and the files that are in the ./admin-main/extensions/folder
  ...
  watcher.on('all', async (event, filePath) => {
    ...
    // The app.js file needs to be copied in the .cache/admin-main/src/app.js and the other ones needs to
    // be copied in the .cache/admin-main/src/extensions folder
    ...
    if (event === 'unlink' || event === 'unlinkDir') {
      ...
      // In any other case just copy the file into the .cache/admin-main/src folder
      try {
